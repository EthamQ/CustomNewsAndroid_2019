...
public class AddArticlesToViewState extends SwipeFragmentState implements ISwipeFragmentState {

    public AddArticlesToViewState(SwipeFragment swipeFragment) {
        super(swipeFragment);
    }
